...
<div class="w3-col l9 s12 ">
    ...
    <label>
        Pick From</label>
        <input id="name" name="pickfrom"  class="w3-input w3-border w3-animate-input" type="text"/  style="width:40%">
    
    <label>
       Drop To</label>
        <input id="phone" class="w3-input w3-border w3-animate-input" name="dropto" type="text"/ style="width:40%">
    <br>
...
<div>
	...
	<p>We offer oneway cabs  <?php  if(isset($_GET['pickfrom'])){ echo 'from ' . ucfirst($_GET['pickfrom']) .' to ';}else if(isset($_POST['pickfrom'])){ echo 'from ' . ucfirst($_POST['pickfrom']) .' to ';}?><?php if(isset($_GET['dropto'])){ echo ucfirst($_GET['dropto']) .' ';}else if(isset($_POST['dropto'])){ echo ucfirst($_POST['dropto']) .' ';} ?> at highly competitive	 rates.
		Get in touch with us if you do not find a suitable offer.
	</p>
	<p>These offers change dynamically. Book immedietely to freeze the oneway drop offer.</p>
</div>
