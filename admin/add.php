...
if(isset($_POST['submit'])) {
	...
	$query = "INSERT INTO  `users` (id, name, email, phone, password, resetpasswordkey,

									agency, address, city, pin, position, noofvehicles, regdate, emailverified, mobileverified,									
									
									usertype, approval) VALUES (NULL, '$name', '$email', '$phone', '$password', '$resetpasswordkey',

									'$agency', '$address', '$city', '$pin', '$position', '$noofvehicles', 'now()',

									'$emailverified', '$mobileverified', 'agent', 0);";
